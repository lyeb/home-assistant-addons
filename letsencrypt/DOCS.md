...
You will need to generate an API key from the IONOS Control Panel at https://developer.hosting.ionos.com/?source=IonosControlPanel.

It is recommended to set the propagation_seconds to >= 600 seconds due to the slow DNS update of IONOS.
